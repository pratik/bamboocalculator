...
<head>
	...
	<title><?php echo $finalarray['pagetitle']; ?></title>
				...
				<div class="col-lg-5 mb-3">
					<div class="costing-columns baminputctrl bboxshadow" style="height:100%;">
						<h2> <?php echo $finalarray['graph']; ?></h2>
				         <div class="formbuilder-number form-group field-land_size">
					        ...
					        <div class="input-group">
							  	...
							  	<span class="input-group-text"><?php echo $finalarray['acre']; ?></span>
							</div>
					    </div>
					    <script>
					    ...
					    <div class="formbuilder-number form-group field-land_density">
					        <label for="land_density" class="formbuilder-number-label"><?php echo $finalarray['plantation_density']; ?>
					        ...
					        <div class="btn-group" id="aBtnGroup" style="">
					            <button type="button" value="U" data-row="10" data-plant="4" class="btn btn-default" style="font-size:14px;"><?php echo $finalarray['ultra_high']; ?></button>
					            <button type="button" value="H" data-row="12" data-plant="6" class="btn btn-default" style="font-size:14px;"><?php echo $finalarray['high']; ?></button>
	                            <button type="button" value="M" data-row="12" data-plant="8" class="btn btn-default active" style="font-size:14px;"><?php echo $finalarray['med']; ?></button>
	                            <button type="button" value="L" data-row="16" data-plant="10" class="btn btn-default" style="font-size:14px;"><?php echo $finalarray['low']; ?></button>
							</div>
					    </div>
					    <div class="formbuilder-number form-group field-plants_per_row">
					        <label for="plants_per_row" class="formbuilder-number-label"><?php echo $finalarray['row_to_row']; ?> </label>
					        <div class="input-group">
							  	...
							  	<span class="input-group-text"><?php echo $finalarray['feet']; ?></span>
							</div>
					    </div>
					    <div class="formbuilder-number form-group field-plants_per_column">
					        <label for="plants_per_column" class="formbuilder-number-label"><?php echo $finalarray['plant_to_plant']; ?> </label>
					        <div class="input-group">
					    ...
					    <div class="text-end">
					    	<small><?php echo $finalarray['total_plants']; ?></small><p id="totalplants" class="bignumber" style="border-radius:5px;">0</p>
					    </div>
					    
					    
					    <!---->
					    
					    <h2><?php echo $finalarray['one_time_investment']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Costs incurred once during setting up the farm"></i></h2>
				      	<div class="formbuilder-number form-group field-onetime_sapling">
					        <label for="onetime_sapling" class="formbuilder-number-label"><?php echo $finalarray['One Sapling Cost']; ?>
					    ...
					    <div class="formbuilder-number form-group field-onetime_drip">
					        <label for="onetime_drip" class="formbuilder-number-label"><?php echo $finalarray['drip_irrigation_installation']; ?>
					        ...
					        <div class="input-group rupeewrapper">
							  	...
							  	<span class="input-group-text"><?php echo $finalarray['per_acre']; ?></span>
							</div>
					    </div>
					     <div class="formbuilder-number form-group field-onetime_labour">
					        <label for="onetime_labour" class="formbuilder-number-label"><?php echo $finalarray['labour']; ?>
					    ...
					    <div class="formbuilder-number form-group field-onetime_overhead">
					        <label for="onetime_overhead" class="formbuilder-number-label"><?php echo $finalarray['additional_overhead_expenses']; ?>
					    ...
					    <!---->
					    <br>
					    	<h2><?php echo $finalarray['yearly_investment']; ?> 
				    	...
				    	<div class="row">
				    		<div class="col-lg-12">
				    			<div class="formbuilder-number form-group field-yearly_fertilizer_required">
							        <label for="yearly_fertilizer_required" class="formbuilder-number-label"><?php echo $finalarray['fertilizer_applied']; ?></label>
							        <div class="input-group">
									    ...
									    <span class="input-group-text"><?php echo $finalarray['kg_per_plant']; ?></span>
							    	</div>
							    </div>
							     <div class="formbuilder-number form-group field-fertilizer_per_kg">
							        <label for="fertilizer_per_kg" class="formbuilder-number-label"><?php echo $finalarray['fertilizer_cost']; ?> 
							        ...
							        <div class="input-group rupeewrapper">
									    ...
									    <span class="input-group-text"><?php echo $finalarray['per_kg']; ?></span>
							    	</div>
							    </div>
							    
							    <div class="formbuilder-number form-group field-yearly_manure_required">
							        <label for="yearly_manure_required" class="formbuilder-number-label"><?php echo $finalarray['manure_applied']; ?></label>
							        <div class="input-group">
							    ...
							    <div class="formbuilder-number form-group field-manure_per_kg">
							        <label for="manure_per_kg" class="formbuilder-number-label">	<?php echo $finalarray['manure_cost']; ?>
							    ...
							    <p class="text-end">
							        <small><?php echo $finalarray['total_fertilizer_cost']; ?>: <b>₹<span class="fertcost"></span></b> </small><br>
							        <small><?php echo $finalarray['total_manure_cost']; ?>: <b>₹<span class="mancost"></span></b></small> 
							    </p>
				    		</div>
				    		<div class="col-lg-12">
				    			<div class="formbuilder-number form-group field-yearly_labor">
							        <label for="yearly_labor" class="formbuilder-number-label"><?php echo $finalarray['labour']; ?> 
							    ...
							    <div class="formbuilder-number form-group field-yearly_electricity">
							        <label for="yearly_electricity" class="formbuilder-number-label"><?php echo $finalarray['electricity_irrigation']; ?></label>
							        <div class="input-group rupeewrapper">
										<span class="input-group-text rupee">₹</span>
						      	...
						      	<div class="formbuilder-number form-group field-yealy_land_cost">
							        <label for="yealy_land_cost" class="formbuilder-number-label"><?php echo $finalarray['land_cost']; ?></label>
							        <div class="input-group rupeewrapper">
										<span class="input-group-text rupee">₹</span>
							    ...
							    <div class="formbuilder-number form-group field-yearly_overhead">
							        <label for="yearly_overhead" class="formbuilder-number-label">
							        	<?php echo $finalarray['additional_overhead_expenses']; ?>
				      ...
				      <div class="row">
	            		    ...
	            		    <div class="col-lg-12 mb-3">
	            		        <div class="costing-columns mb-3"  style="background:#000;color:white;">
	                					...
	                					<div class="row">
	                						<div class="col-lg-12">
	                						<h2><?php echo $finalarray['revenue_fourth_year_onwards']; ?>
	                					...
	                					<ul class="nav nav-tabs" id="myTab" role="tablist">
	                					  <li class="nav-item" role="presentation">
	                					    <button class="nav-link active" id="sellbyquantity-tab" data-bs-toggle="tab" data-bs-target=".sellbyquantity" type="button" role="tab" aria-controls="sellbyquantity" aria-selected="true">	<?php echo $finalarray['Sell by Quantity']; ?></button>
	                					  </li>
	                					  <li class="nav-item" role="presentation">
	                					    <button class="nav-link" id="sellbyweight-tab" data-bs-toggle="tab" data-bs-target=".sellbyweight" type="button" role="tab" aria-controls="sellbyweight" aria-selected="false">	<?php echo $finalarray['Sell by Weight']; ?></button>
	                					  </li>
	                					</ul>
	                					<div class="tab-content baminputctrl">
	                						<div class="tab-pane active sellbyquantity " id="sellbyquantity" role="tabpanel" aria-labelledby="sellbyquantity-tab">
	                							<div class="row">
	                								<div class=col-lg-12>
	                									<div class="formbuilder-number form-group field-revenue_number_of_poles_per_plant mt-3">
	                								        <label for="revenue_number_of_poles_per_plant" class="formbuilder-number-label">	<?php echo $finalarray['Poles per plant per year']; ?>
	                										...
	                										<div class="input-group">
	                											...
	                											<span class="input-group-text">	<?php echo $finalarray['culms']; ?></span>
	                										</div>
	                								    </div>
	                								</div>
	                								<div class=col-lg-12>
	                									<div class="formbuilder-number form-group field-revenue_per_culm ">
	                								        <label for="revenue_per_culm" class="formbuilder-number-label">	<?php echo $finalarray['Market price per Pole']; ?>
	                						    ...
	                						    <p>	<?php echo $finalarray['revenue_per_year']; ?>: <br>₹<span class="revenue_year_4_sell_by_qty mediumnumber"></span></p>
	                					 	</div>
	                						<div class="tab-pane sellbyweight"  id="sellbyweight" role="tabpanel" aria-labelledby="sellbyweight-tab">
	                							<div class="row">
	                								<div class=col-lg-12>
	                									<div class="formbuilder-number form-group field-revenue_weight_per_pole mt-3">
	                									        <label for="revenue_weight_per_pole" class="formbuilder-number-label">	<?php echo $finalarray['avgweight']; ?></label>		    	
	                										<div class="input-group">
	                											...
	                											<span class="input-group-text"><?php echo $finalarray['kg']; ?></span>
	                										</div>
	                								    </div>
	                								</div>
	                								<div class=col-lg-12>
	                									<div class="formbuilder-number form-group field-revenue_per_ton ">
	                								        <label for="revenue_per_ton" class="formbuilder-number-label">	<?php echo $finalarray['market_price_per_ton']; ?></label>		    	
	                										<div class="input-group rupeewrapper">
	                										  	<span class="input-group-text rupee">₹</span>
	                							...
	                							<hr>
	                						    <p>	<?php echo $finalarray['revenue_per_year_by_weight']; ?>: <br>₹<span class="revenue_year_4_sell_by_weight mediumnumber"></span></p>
	                						</div>
	                					</div>
	                					
	                					<br>
	                					  <p><?php echo $finalarray['profitinfo']; ?></p>
	                                    <br><br>
	                					
	                					<h2><?php echo $finalarray['Bamboo_farming_profit']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title="These calculations are linear. Profit increases exponentialy with time with decreasing Investment/maintenance and increased revenue each year due to more poles produced each year. Value addition to bamboo can create 3x-10x more income."></i>  
	                					</h2>
	                    			    	<div class="formbuilder-number form-group field-years-net-profit mt-2">
	                    						<div class="input-group">
	                    							<span class="input-group-text">	<?php echo $finalarray['upto']; ?></span>
	                    							...
	                    							<span class="input-group-text">	<?php echo $finalarray['years']; ?></span>
	                    						</div>
	                    				    </div>
	                    				
	                    				<div class="row">
	                    			    	<div class="col-12 bqtab" style="">
	                    			    		<b><?php echo $finalarray['Based_on_quantity']; ?></b><hr>
	                    			    		<p>	<?php echo $finalarray['Lifetime_Revenue']; ?> <br><span class="mediumnumber">+ </span> ₹<span class="profit_revenue_qty mediumnumber"></span></p>
	                    			    		<p>	<?php echo $finalarray['Lifetime_Investment']; ?> <br><span class="mediumnumber">&ndash; </span> ₹<span class="profit_investment mediumnumber"></span></p><hr>
	                    			    		<p><?php echo $finalarray['Total_Profit_Loss']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Revenue - Investments)"></i><br>₹<span class="profit_by_qty bignumber"></span></p><hr>
	                    			    		<div class="row">
	                    					    	<div class="col-lg-4">
	                    					    		<p><?php echo $finalarray['Profit_per_year']; ?> <br>₹<span class="unitcalc_profit_per_year mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    		<p>	<?php echo $finalarray['Profit_per_Month']; ?><br>₹<span class="unitcalc_profit_per_month mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    	</div>
	                    					    </div>
	                    					    ...
	                    					    <div class="row">
	                    					    	<div class="col-lg-4">
	                    					    		<p><?php echo $finalarray['Investment_per_Plant']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Total Investment/ Total Plants)"></i>  <br>₹<span class="unitcalc_investment_per_plant mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    		<p><?php echo $finalarray['Revenue_per_Plant']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Total Revenue/ Total Plants)"></i>  <br>₹<span class="unitcalc_revenue_per_plant mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    		<p>	<?php echo $finalarray['Profit_per_Plant']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Total Profit/Total Plants)"></i>  <br>₹<span class="unitcalc_profit_per_plant mediumnumber"></span></p>
	                    					    	</div>
	                    					    </div>
	                    			    	</div>
	                    			    	...
	                    			    	<div class="col-12 bwtab" style="display:none;">
	                    			    		<b>	<?php echo $finalarray['Based_on_Weight']; ?></b><hr> 
	                    			    		<p>	<?php echo $finalarray['Lifetime_Revenue']; ?> <br><span class="mediumnumber">+ </span> ₹<span class="profit_revenue_weight mediumnumber"></span></p>
	                    			    		<p>	<?php echo $finalarray['Lifetime_Investment']; ?> <br><span class="mediumnumber">&ndash; </span> ₹<span class="profit_investment mediumnumber"></span></p><hr>
	                    			    		<p><?php echo $finalarray['Total_Profit_Loss']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Revenue - Investments)"></i> <br>₹<span class="profit_by_weight bignumber"></span></p><hr>
	                    			    		<div class="row">
	                    					    	<div class="col-lg-4">
	                    					    		<p><?php echo $finalarray['Profit_per_year']; ?> <br>₹<span class="unitcalc_profit_per_year_weight mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    		<p>	<?php echo $finalarray['Profit_per_Month']; ?><br>₹<span class="unitcalc_profit_per_month_weight mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    	</div>
	                    					    </div>	
	                    					    <div class="row">
	                    					    	<div class="col-lg-4">
	                    					    		<p><?php echo $finalarray['Investment_per_Plant']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Total Investment/ Total Plants)"></i>  <br>₹<span class="unitcalc_investment_per_plant_weight mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    		<p><?php echo $finalarray['Revenue_per_Plant']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Total Revenue/ Total Plants)"></i>  <br>₹<span class="unitcalc_revenue_per_plant_weight mediumnumber"></span></p>
	                    					    	</div>
	                    					    	<div class="col-lg-4">
	                    					    		<p>	<?php echo $finalarray['Profit_per_Plant']; ?> <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title=" = (Total Profit/Total Plants)"></i>  <br>₹<span class="unitcalc_profit_per_plant_weight mediumnumber"></span></p>
	                    					    	</div>
	                    					    </div>
	                    			    	</div>
...
<script>
 ...
 <!-- Language -->
 <form method='get' action='' id='form_lang' style="position:fixed;top:20px;right:30px;">
   ...
   <option value='hi' <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'hi'){ echo "selected"; } ?> >Hindi</option>
    <option value='gj' <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'gj'){ echo "selected"; } ?> >Gujarati</option>
  </select>
 </form>
